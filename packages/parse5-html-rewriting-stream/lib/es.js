...
var DevNullStream =
    /*#__PURE__*/
    (function(_Writable) {
        _inherits(DevNullStream, _Writable);

        function DevNullStream() {
            _classCallCheck(this, DevNullStream);

            return _possibleConstructorReturn(this, _getPrototypeOf(DevNullStream).apply(this, arguments));
        }

        _createClass(DevNullStream, [
            {
                key: '_write',
...
var ParserFeedbackSimulator =
    /*#__PURE__*/
    (function() {
        function ParserFeedbackSimulator(tokenizer$$1) {
            ...
            },
            {
                ...
                value: function _handleStartTagToken(token) {
                    ...
                    if (this.inForeignContent) {
                        ...
                        if (tn === $$2.PRE || tn === $$2.TEXTAREA || tn === $$2.LISTING) {
                            this.skipNextNewLine = true;
                        } else if (tn === $$2.IMAGE) {
                            token.tagName = $$2.IMG;
                        }
            ...
            },
            {
                ...
                value: function _handleEndTagToken(token) {
                    ...
                    if (!this.inForeignContent) {
                        ...
                        (tn === $$2.SVG && this.currentNamespace === NS.SVG) ||
                        (tn === $$2.MATH && this.currentNamespace === NS.MATHML)
                    ) {
                        this._leaveCurrentNamespace();
...
var parserFeedbackSimulator = ParserFeedbackSimulator;
...
var SAXParser =
    ...
    (function(_Transform) {
        ...
        function SAXParser(options) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(SAXParser).call(this, {
                    encoding: 'utf8',
                    decodeStrings: false
                })
            );
            ...
            if (_this.options.sourceCodeLocationInfo) {
                _this.locInfoMixin = mixin.install(_this.tokenizer, tokenizerMixin);
            }
...
var TOKEN_EMISSION_HELPERS = ((_TOKEN_EMISSION_HELPE2 = {}),
_defineProperty(_TOKEN_EMISSION_HELPE2, tokenizer.START_TAG_TOKEN, {
    eventName: 'startTag',
...
var NS$1 = html.NAMESPACES; //Default serializer options
                ...
                value: function _serializeElement(node) {
                    ...
                    if (
                        ...
                        var childNodesHolder =
                            tn === $$3.TEMPLATE && ns === NS$1.HTML ? this.treeAdapter.getTemplateContent(node) : node;
...
var escapeString = serializer.escapeString;
...
var RewritingStream =
    ...
    (function(_SAXParser) {
        ...
        function RewritingStream() {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(RewritingStream).call(this, {
