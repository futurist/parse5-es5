                        ...
                        if (nodeWithData) {
                            ...
                            result =
                                current & DATA_DUPLET_FLAG
                                    ? [namedEntityData[++i], namedEntityData[++i]]
                                    : [namedEntityData[++i]];
                            excess = 0;
                        }
            ...
            },
            {
                ...
                value: function value() {
                    if (this.charRefCode === $$1.NULL) {
                        ...
                        this.charRefCode === $$1.CARRIAGE_RETURN
                    ) {
...
var Mixin =
    ...
    (function() {
        function Mixin(host) {
            ...
            var _arr = Object.keys(overriddenMethods);
    ...
    (function(_Mixin) {
        ...
        function PositionTrackingPreprocessorMixin(preprocessor) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(PositionTrackingPreprocessorMixin).call(this, preprocessor)
            );
...
var LocationInfoTokenizerMixin =
    ...
    (function(_Mixin) {
        ...
        function LocationInfoTokenizerMixin(tokenizer$$1) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(LocationInfoTokenizerMixin).call(this, tokenizer$$1)
            );
            _this.tokenizer = tokenizer$$1;
            _this.posTracker = mixin.install(tokenizer$$1.preprocessor, preprocessorMixin);
...
var LocationInfoOpenElementStackMixin =
    /*#__PURE__*/
    (function(_Mixin) {
        ...
        function LocationInfoOpenElementStackMixin(stack, opts) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(LocationInfoOpenElementStackMixin).call(this, stack)
            );
                    ...
                    return {
                        ...
                        _processToken: function _processToken(token) {
                            ...
                            var requireExplicitUpdate =
                                ...
                                (token.tagName === $$3.HTML ||
                                    (token.tagName === $$3.BODY && this.openElements.hasInScope($$3.BODY)));
...
var ErrorReportingPreprocessorMixin =
    /*#__PURE__*/
    (function(_ErrorReportingMixinB) {
        ...
        function ErrorReportingPreprocessorMixin(preprocessor, opts) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(ErrorReportingPreprocessorMixin).call(this, preprocessor, opts)
            );
            _this.posTracker = mixin.install(preprocessor, preprocessorMixin);
        ...
        _createClass(ErrorReportingPreprocessorMixin, [
            {
                ...
                value: function _reportError(code) {
                    ...
                    if (this.lastErrOffset !== this.posTracker.offset) {
                        ...
                        _get(_getPrototypeOf(ErrorReportingPreprocessorMixin.prototype), '_reportError', this).call(
                            this,
                            code
                        );
                    }
...
var ErrorReportingTokenizerMixin =
    /*#__PURE__*/
    (function(_ErrorReportingMixinB) {
        ...
        function ErrorReportingTokenizerMixin(tokenizer, opts) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(ErrorReportingTokenizerMixin).call(this, tokenizer, opts)
            );
...
var ErrorReportingParserMixin =
    ...
    (function(_ErrorReportingMixinB) {
        ...
        function ErrorReportingParserMixin(parser, opts) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(ErrorReportingParserMixin).call(this, parser, opts)
            );
            _this.opts = opts;
            _this.ctLoc = null;
...
var foreignContent = createCommonjsModule(function(module, exports) {
    ...
    var EXITS_FOREIGN_CONTENT = ((_EXITS_FOREIGN_CONTEN = {}),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.B, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.BIG, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.BLOCKQUOTE, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.BODY, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.BR, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.CENTER, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.CODE, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.DD, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.DIV, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.DL, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.DT, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.EM, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.EMBED, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.H1, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.H2, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.H3, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.H4, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.H5, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.H6, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.HEAD, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.HR, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.I, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.IMG, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.LI, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.LISTING, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.MENU, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.META, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.NOBR, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.OL, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.P, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.PRE, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.RUBY, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.S, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.SMALL, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.SPAN, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.STRONG, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.STRIKE, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.SUB, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.SUP, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.TABLE, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.TT, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.U, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.UL, true),
    _defineProperty(_EXITS_FOREIGN_CONTEN, $.VAR, true),
    _EXITS_FOREIGN_CONTEN); //Check exit from foreign content
...
var _INSERTION_MODE_RESET,
    _TEMPLATE_INSERTION_M,
    _INITIAL_MODE,
    _BEFORE_HTML_MODE,
    _BEFORE_HEAD_MODE,
    _IN_HEAD_MODE,
    _IN_HEAD_NO_SCRIPT_MO,
    _AFTER_HEAD_MODE,
    _IN_BODY_MODE,
    _TEXT_MODE,
    _IN_TABLE_MODE,
    ...
    _IN_CELL_MODE,
    _IN_SELECT_MODE,
    _IN_SELECT_IN_TABLE_M,
    _IN_TEMPLATE_MODE,
    _AFTER_BODY_MODE,
    _IN_FRAMESET_MODE,
    _AFTER_FRAMESET_MODE,
    _AFTER_AFTER_BODY_MOD,
    _AFTER_AFTER_FRAMESET,
    _TOKEN_HANDLERS;
...
_defineProperty(_INSERTION_MODE_RESET, $$4.TR, IN_ROW_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.TBODY, IN_TABLE_BODY_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.THEAD, IN_TABLE_BODY_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.TFOOT, IN_TABLE_BODY_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.CAPTION, IN_CAPTION_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.COLGROUP, IN_COLUMN_GROUP_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.TABLE, IN_TABLE_MODE),
_defineProperty(_INSERTION_MODE_RESET, $$4.BODY, IN_BODY_MODE),
...
var TEMPLATE_INSERTION_MODE_SWITCH_MAP = ((_TEMPLATE_INSERTION_M = {}),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.CAPTION, IN_TABLE_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.COLGROUP, IN_TABLE_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.TBODY, IN_TABLE_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.TFOOT, IN_TABLE_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.THEAD, IN_TABLE_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.COL, IN_COLUMN_GROUP_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.TR, IN_TABLE_BODY_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.TD, IN_ROW_MODE),
_defineProperty(_TEMPLATE_INSERTION_M, $$4.TH, IN_ROW_MODE),
_TEMPLATE_INSERTION_M); //Token handlers map for insertion modes

var TOKEN_HANDLERS = ((_TOKEN_HANDLERS = {}),
_defineProperty(
    _TOKEN_HANDLERS,
    INITIAL_MODE,
    ((_INITIAL_MODE = {}),
    _defineProperty(_INITIAL_MODE, tokenizer.CHARACTER_TOKEN, tokenInInitialMode),
    _defineProperty(_INITIAL_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenInInitialMode),
    _defineProperty(_INITIAL_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_INITIAL_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_INITIAL_MODE, tokenizer.DOCTYPE_TOKEN, doctypeInInitialMode),
    _defineProperty(_INITIAL_MODE, tokenizer.START_TAG_TOKEN, tokenInInitialMode),
    _defineProperty(_INITIAL_MODE, tokenizer.END_TAG_TOKEN, tokenInInitialMode),
    _defineProperty(_INITIAL_MODE, tokenizer.EOF_TOKEN, tokenInInitialMode),
    _INITIAL_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    BEFORE_HTML_MODE,
    ((_BEFORE_HTML_MODE = {}),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.CHARACTER_TOKEN, tokenBeforeHtml),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenBeforeHtml),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.START_TAG_TOKEN, startTagBeforeHtml),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.END_TAG_TOKEN, endTagBeforeHtml),
    _defineProperty(_BEFORE_HTML_MODE, tokenizer.EOF_TOKEN, tokenBeforeHtml),
    _BEFORE_HTML_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    BEFORE_HEAD_MODE,
    ((_BEFORE_HEAD_MODE = {}),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.CHARACTER_TOKEN, tokenBeforeHead),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenBeforeHead),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.DOCTYPE_TOKEN, misplacedDoctype),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.START_TAG_TOKEN, startTagBeforeHead),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.END_TAG_TOKEN, endTagBeforeHead),
    _defineProperty(_BEFORE_HEAD_MODE, tokenizer.EOF_TOKEN, tokenBeforeHead),
    _BEFORE_HEAD_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_HEAD_MODE,
    ((_IN_HEAD_MODE = {}),
    _defineProperty(_IN_HEAD_MODE, tokenizer.CHARACTER_TOKEN, tokenInHead),
    _defineProperty(_IN_HEAD_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenInHead),
    _defineProperty(_IN_HEAD_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_HEAD_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_HEAD_MODE, tokenizer.DOCTYPE_TOKEN, misplacedDoctype),
    _defineProperty(_IN_HEAD_MODE, tokenizer.START_TAG_TOKEN, startTagInHead),
    _defineProperty(_IN_HEAD_MODE, tokenizer.END_TAG_TOKEN, endTagInHead),
    _defineProperty(_IN_HEAD_MODE, tokenizer.EOF_TOKEN, tokenInHead),
    _IN_HEAD_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    ...
    ((_IN_HEAD_NO_SCRIPT_MO = {}),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.CHARACTER_TOKEN, tokenInHeadNoScript),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.NULL_CHARACTER_TOKEN, tokenInHeadNoScript),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.DOCTYPE_TOKEN, misplacedDoctype),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.START_TAG_TOKEN, startTagInHeadNoScript),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.END_TAG_TOKEN, endTagInHeadNoScript),
    _defineProperty(_IN_HEAD_NO_SCRIPT_MO, tokenizer.EOF_TOKEN, tokenInHeadNoScript),
    _IN_HEAD_NO_SCRIPT_MO)
),
_defineProperty(
    _TOKEN_HANDLERS,
    AFTER_HEAD_MODE,
    ((_AFTER_HEAD_MODE = {}),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.CHARACTER_TOKEN, tokenAfterHead),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenAfterHead),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.DOCTYPE_TOKEN, misplacedDoctype),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.START_TAG_TOKEN, startTagAfterHead),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.END_TAG_TOKEN, endTagAfterHead),
    _defineProperty(_AFTER_HEAD_MODE, tokenizer.EOF_TOKEN, tokenAfterHead),
    _AFTER_HEAD_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_BODY_MODE,
    ((_IN_BODY_MODE = {}),
    _defineProperty(_IN_BODY_MODE, tokenizer.CHARACTER_TOKEN, characterInBody),
    _defineProperty(_IN_BODY_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_BODY_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_IN_BODY_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_BODY_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_BODY_MODE, tokenizer.START_TAG_TOKEN, startTagInBody),
    _defineProperty(_IN_BODY_MODE, tokenizer.END_TAG_TOKEN, endTagInBody),
    _defineProperty(_IN_BODY_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_BODY_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    TEXT_MODE,
    ((_TEXT_MODE = {}),
    _defineProperty(_TEXT_MODE, tokenizer.CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_TEXT_MODE, tokenizer.NULL_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_TEXT_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_TEXT_MODE, tokenizer.COMMENT_TOKEN, ignoreToken),
    _defineProperty(_TEXT_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_TEXT_MODE, tokenizer.START_TAG_TOKEN, ignoreToken),
    _defineProperty(_TEXT_MODE, tokenizer.END_TAG_TOKEN, endTagInText),
    _defineProperty(_TEXT_MODE, tokenizer.EOF_TOKEN, eofInText),
    _TEXT_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_TABLE_MODE,
    ((_IN_TABLE_MODE = {}),
    _defineProperty(_IN_TABLE_MODE, tokenizer.CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_TABLE_MODE, tokenizer.NULL_CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_TABLE_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_TABLE_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_TABLE_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_TABLE_MODE, tokenizer.START_TAG_TOKEN, startTagInTable),
    _defineProperty(_IN_TABLE_MODE, tokenizer.END_TAG_TOKEN, endTagInTable),
    _defineProperty(_IN_TABLE_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_TABLE_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_TABLE_TEXT_MODE,
    ((_IN_TABLE_TEXT_MODE = {}),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.CHARACTER_TOKEN, characterInTableText),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInTableText),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.COMMENT_TOKEN, tokenInTableText),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.DOCTYPE_TOKEN, tokenInTableText),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.START_TAG_TOKEN, tokenInTableText),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.END_TAG_TOKEN, tokenInTableText),
    _defineProperty(_IN_TABLE_TEXT_MODE, tokenizer.EOF_TOKEN, tokenInTableText),
    _IN_TABLE_TEXT_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_CAPTION_MODE,
    ((_IN_CAPTION_MODE = {}),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.CHARACTER_TOKEN, characterInBody),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.START_TAG_TOKEN, startTagInCaption),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.END_TAG_TOKEN, endTagInCaption),
    _defineProperty(_IN_CAPTION_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_CAPTION_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    ...
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenInColumnGroup),
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.START_TAG_TOKEN, startTagInColumnGroup),
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.END_TAG_TOKEN, endTagInColumnGroup),
    _defineProperty(_IN_COLUMN_GROUP_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_COLUMN_GROUP_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_TABLE_BODY_MODE,
    ((_IN_TABLE_BODY_MODE = {}),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.NULL_CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.START_TAG_TOKEN, startTagInTableBody),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.END_TAG_TOKEN, endTagInTableBody),
    _defineProperty(_IN_TABLE_BODY_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_TABLE_BODY_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_ROW_MODE,
    ((_IN_ROW_MODE = {}),
    _defineProperty(_IN_ROW_MODE, tokenizer.CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_ROW_MODE, tokenizer.NULL_CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_ROW_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, characterInTable),
    _defineProperty(_IN_ROW_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_ROW_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_ROW_MODE, tokenizer.START_TAG_TOKEN, startTagInRow),
    _defineProperty(_IN_ROW_MODE, tokenizer.END_TAG_TOKEN, endTagInRow),
    _defineProperty(_IN_ROW_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_ROW_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_CELL_MODE,
    ((_IN_CELL_MODE = {}),
    _defineProperty(_IN_CELL_MODE, tokenizer.CHARACTER_TOKEN, characterInBody),
    _defineProperty(_IN_CELL_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_CELL_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_IN_CELL_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_CELL_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_CELL_MODE, tokenizer.START_TAG_TOKEN, startTagInCell),
    _defineProperty(_IN_CELL_MODE, tokenizer.END_TAG_TOKEN, endTagInCell),
    _defineProperty(_IN_CELL_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_CELL_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_SELECT_MODE,
    ((_IN_SELECT_MODE = {}),
    _defineProperty(_IN_SELECT_MODE, tokenizer.CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_SELECT_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_SELECT_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_SELECT_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_SELECT_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_SELECT_MODE, tokenizer.START_TAG_TOKEN, startTagInSelect),
    _defineProperty(_IN_SELECT_MODE, tokenizer.END_TAG_TOKEN, endTagInSelect),
    _defineProperty(_IN_SELECT_MODE, tokenizer.EOF_TOKEN, eofInBody),
    _IN_SELECT_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    ...
    ((_IN_SELECT_IN_TABLE_M = {}),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.START_TAG_TOKEN, startTagInSelectInTable),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.END_TAG_TOKEN, endTagInSelectInTable),
    _defineProperty(_IN_SELECT_IN_TABLE_M, tokenizer.EOF_TOKEN, eofInBody),
    _IN_SELECT_IN_TABLE_M)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_TEMPLATE_MODE,
    ((_IN_TEMPLATE_MODE = {}),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.CHARACTER_TOKEN, characterInBody),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.START_TAG_TOKEN, startTagInTemplate),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.END_TAG_TOKEN, endTagInTemplate),
    _defineProperty(_IN_TEMPLATE_MODE, tokenizer.EOF_TOKEN, eofInTemplate),
    _IN_TEMPLATE_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    AFTER_BODY_MODE,
    ((_AFTER_BODY_MODE = {}),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.CHARACTER_TOKEN, tokenAfterBody),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.NULL_CHARACTER_TOKEN, tokenAfterBody),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.COMMENT_TOKEN, appendCommentToRootHtmlElement),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.START_TAG_TOKEN, startTagAfterBody),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.END_TAG_TOKEN, endTagAfterBody),
    _defineProperty(_AFTER_BODY_MODE, tokenizer.EOF_TOKEN, stopParsing),
    _AFTER_BODY_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    IN_FRAMESET_MODE,
    ((_IN_FRAMESET_MODE = {}),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.START_TAG_TOKEN, startTagInFrameset),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.END_TAG_TOKEN, endTagInFrameset),
    _defineProperty(_IN_FRAMESET_MODE, tokenizer.EOF_TOKEN, stopParsing),
    _IN_FRAMESET_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    AFTER_FRAMESET_MODE,
    ((_AFTER_FRAMESET_MODE = {}),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.WHITESPACE_CHARACTER_TOKEN, insertCharacters),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.COMMENT_TOKEN, appendComment),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.START_TAG_TOKEN, startTagAfterFrameset),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.END_TAG_TOKEN, endTagAfterFrameset),
    _defineProperty(_AFTER_FRAMESET_MODE, tokenizer.EOF_TOKEN, stopParsing),
    _AFTER_FRAMESET_MODE)
),
_defineProperty(
    _TOKEN_HANDLERS,
    ...
    ((_AFTER_AFTER_BODY_MOD = {}),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.CHARACTER_TOKEN, tokenAfterAfterBody),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.NULL_CHARACTER_TOKEN, tokenAfterAfterBody),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.COMMENT_TOKEN, appendCommentToDocument),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.START_TAG_TOKEN, startTagAfterAfterBody),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.END_TAG_TOKEN, tokenAfterAfterBody),
    _defineProperty(_AFTER_AFTER_BODY_MOD, tokenizer.EOF_TOKEN, stopParsing),
    _AFTER_AFTER_BODY_MOD)
),
_defineProperty(
    _TOKEN_HANDLERS,
    ...
    ((_AFTER_AFTER_FRAMESET = {}),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.NULL_CHARACTER_TOKEN, ignoreToken),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.WHITESPACE_CHARACTER_TOKEN, whitespaceCharacterInBody),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.COMMENT_TOKEN, appendCommentToDocument),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.DOCTYPE_TOKEN, ignoreToken),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.START_TAG_TOKEN, startTagAfterAfterFrameset),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.END_TAG_TOKEN, ignoreToken),
    _defineProperty(_AFTER_AFTER_FRAMESET, tokenizer.EOF_TOKEN, stopParsing),
    _AFTER_AFTER_FRAMESET)
),
_TOKEN_HANDLERS); //Parser
        ...
        _createClass(Parser, [
            ...
            },
            {
                ...
                value: function _shouldProcessTokenInForeignContent(token) {
                    ...
                    var isMathMLTextStartTag =
                        token.type === tokenizer.START_TAG_TOKEN &&
                        token.tagName !== $$4.MGLYPH &&
                        token.tagName !== $$4.MALIGNMARK;
            ...
            },
            {
                ...
                value: function _isElementCausesFosterParenting(element) {
                    var tn = this.treeAdapter.getTagName(element);
                    return (
                        tn === $$4.TABLE || tn === $$4.TBODY || tn === $$4.TFOOT || tn === $$4.THEAD || tn === $$4.TR
                    );
                }
            },
            {
...
function tokenInHeadNoScript(p, token) {
    var errCode =
        token.type === tokenizer.EOF_TOKEN
            ? errorCodes.openElementsLeftAfterEof
            : errorCodes.disallowedContentInNoscriptInHead;
...
var ParserStream =
    /*#__PURE__*/
    (function(_Writable) {
        _inherits(ParserStream, _Writable);
        ...
        function ParserStream(options) {
            ...
            _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(ParserStream).call(this, {
                    decodeStrings: false
                })
            );
            _this.parser = new parser(options);
            _this.lastChunkWritten = false;
            _this.writeCallback = null;
            _this.pausedByScript = false;
            _this.document = _this.parser.treeAdapter.createDocument();
            _this.pendingHtmlInsertions = [];
            _this._resume = _this._resume.bind(_assertThisInitialized(_assertThisInitialized(_this)));
            _this._documentWrite = _this._documentWrite.bind(_assertThisInitialized(_assertThisInitialized(_this)));
            _this._scriptHandler = _this._scriptHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));

            _this.parser._bootstrap(_this.document, null);
        ...
        _createClass(ParserStream, [
            ...
            },
            {
                ...
                value: function end(chunk, encoding, callback) {
                    ...
                    _get(_getPrototypeOf(ParserStream.prototype), 'end', this).call(
                        this,
                        chunk || '',
                        encoding,
                        callback
            ...
            {
                key: '_documentWrite',
                value: function _documentWrite(html) {
            ...
            {
                key: '_scriptHandler',
                value: function _scriptHandler(scriptElement) {
...
var lib = ParserStream;

var $$5 = html.TAG_NAMES;

var PlainTextConversionStream =
    /*#__PURE__*/
    (function(_ParserStream) {
        _inherits(PlainTextConversionStream, _ParserStream);

        function PlainTextConversionStream(options) {
            var _this;

            _classCallCheck(this, PlainTextConversionStream);

            _this = _possibleConstructorReturn(this, _getPrototypeOf(PlainTextConversionStream).call(this, options)); // NOTE: see https://html.spec.whatwg.org/#read-text

            _this.parser._insertFakeElement($$5.HTML);

            _this.parser._insertFakeElement($$5.HEAD);

            _this.parser.openElements.pop();

            _this.parser._insertFakeElement($$5.BODY);

            _this.parser._insertFakeElement($$5.PRE);

            _this.parser.treeAdapter.insertText(_this.parser.openElements.current, '\n');

            _this.parser.switchToPlaintextParsing();

            return _this;
        }

        return PlainTextConversionStream;
    })(lib);

var lib$1 = PlainTextConversionStream;
